# Git 相關設定
#
# 實際內容在 ~/dotfiles/shell/ 底下 —— 那些檔案是「可攜版」，
...
source "$HOME/dotfiles/shell/git-aliases.sh"   # 46 個 alias，並移除 13 個危險的
source "$HOME/dotfiles/shell/git-audit.sh"     # git-audit 函式：找出只存在本機的工作
